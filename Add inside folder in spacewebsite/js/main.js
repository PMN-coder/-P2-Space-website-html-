...
function createRing(innerRadius) {
  // FIXED: Changed minus to plus so outerRadius is larger than innerRadius
...
function init() {
  ...
  // setSkyBox(); // <-- DISABLED: This allows the CSS background to show through the transparent canvas
  ...
  // Canvas initialized with alpha: true, making it transparent
  ...
  // FIXED: Pulled camera back and up to see all orbits
